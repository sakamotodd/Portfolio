...
export const useIconData = () => {
  const tableContent = [
    ...
    },
    {
      ...
      photo: 'c-logo.png',
      content:
        '仕事の業務ではvisual studioを用いたC#での開発をやっていました。',
    },
    {
      title: 'Github',
      star: '★★★☆☆',
      photo: 'github.png',
      content:
        'ソースコードはgithubを使用し、デプロイ先はVercelを活用していました。',
    },
    {
      title: 'React',
      star: '★★★★☆',
    ...
    },
    {
      ...
      photo: 'firebase.png',
      content:
        '認証機能、DBの操作としてfirebaseを用いました。主にUdemyの教材で勉強しました。',
    },
    {
      title: 'jest',
      star: '★★★☆☆',
      photo: 'jest.png',
      content:
        'testの一環としてjestを活用しました。業務上では、NUnitでコーディングしていました。',
    },
  ];
